...
```powershell
C:\Users\you\.venvs\zotero_fulltext_mcp\Scripts\python.exe -m pip install "zotero-fulltext-mcp[mcp] @ git+https://github.com/matthiaskloft/zotero-fulltext-mcp.git@v0.8.0"
```

macOS/Linux:

```bash
~/.venvs/zotero_fulltext_mcp/bin/python -m pip install 'zotero-fulltext-mcp[mcp] @ git+https://github.com/matthiaskloft/zotero-fulltext-mcp.git@v0.8.0'
```
